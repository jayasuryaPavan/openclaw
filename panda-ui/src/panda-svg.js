...
export function createPandaFace() {
    ...
    svg.append(earLeft, earRight, face, patchLeft, patchRight, eyeWhiteLeft, eyeWhiteRight, pupilLeft, pupilRight, shineLeft, shineRight, blushLeft, blushRight, nose, mouthGroup, thinkGroup);
    let mouthTimer = null;
